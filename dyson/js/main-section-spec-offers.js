...
function addToCartWindowWidthMore760(e) {
    ...
    if (target.closest('.into-a-basket') && +headerNumberOfProducts.textContent + (+target.closest('.add-to-cart').querySelector('.quantity').textContent) < 10 && window.innerWidth > 760) {
